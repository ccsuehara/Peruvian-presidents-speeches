...
speech.loc[(speech['year'].astype('int32') >= 1995) &            (speech['year'].astype('int32') <= 1999), 'administration'] = 'Fujimori(2)'
speech.loc[(speech['year'].astype('int32') == 2000)                                                      , 'administration'] = 'Fujimori(3)'
